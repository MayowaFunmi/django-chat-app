...
def signup(request):
    ...
    return render(request, 'users/signup_copy.html', context)
'''
...
def user_profile(request):
    ...
    if user_pro.first_name is None:
        form = ProfileForm()
        if request.method == 'POST':
            form = ProfileForm(
            ...
            if form.is_valid():
                form.cleaned_data['gender'].capitalize()
    ...
    return render(request, 'users/create_profile_copy.html', {'form': form})
